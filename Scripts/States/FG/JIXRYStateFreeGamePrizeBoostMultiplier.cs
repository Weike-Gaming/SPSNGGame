...
{
    public class JIXRYStateFreeGamePrizeBoostMultiplier : WkSlotStateCore
    {
        public JIXRYStateFreeGamePrizeBoostMultiplier(string id, string fallBackStateId, IWkObject owner) : base(id, fallBackStateId, owner)
        {
        }
        ...
        public override void EnterState()
        {
            ...
            {
                InvokeMethod(() => playerController?.InvokeActions("Key_Spin_BurnIn"), 0.5f);
            }
            #endregion
        }
